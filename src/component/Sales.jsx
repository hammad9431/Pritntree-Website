...
<div >
    ...
    <div >
     <img className=' px-4 lg:mt-20  lg:absolute h-20 lg:h-44 md:h-44 mt-16  xl:ml-2 md:ml-40 lg:hidden xl:inline-block' src="src/assets/images/quote_page_22-6d40d25f61a20e5ac44b9a4e56c810d91bb563b63f98e10b0c512ca1186913e3.svg" alt="" />
</div>
</div>
</div>
...
<div>
    ...
    <img className='h-28 lg:h-40 md:h-40 mt-20 xl:ml-[43%] lg:ml-[30%] md:ml-[19%]' src="src/assets/images/show_quote_wo_tv-1e4a4b454d31dcfa5cb943b8bc5a5c6051f0a161a19a22c82a7d8e13fd60b7d2.svg" alt="" />
...
<div className=''>
    ...
    <img className='md:mx-auto' src="src/assets/images/c458.webp" alt="" />
</div>
