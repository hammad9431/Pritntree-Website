import image1 from '../assets/images/win_award_icon_1-89c128609fa3fc8495c94e11ffb8992eaf6d828ebf81514766166b8636c68645.png'
import image2 from '../assets/images/land_icon_1-d5e368cd662855c0a1eb4a0f89c8ac18524dd2fdba949fb0680e8cc09258b440.jpg'
import image3 from '../assets/images/land_icon_2-51018966c0aecd143aa8b42202e980eaf72899e7750fa0dbf713529e8e86885c.jpg'
import image4 from '../assets/images/land_icon_3-1c63582a0ebeb5ce8d0457f4cbda3fc91bf1007b57a9f50ea4f1a5ec1fbff1fc.jpg'
function Reward() {
  return (
    <>
...
{/* Box--1 */}
<div className="md:w-[95%] w-[95%] lg:w-[95%] mx-auto p-4 relative card !border-t-[3px] !border-t-blue-500 !border-solid">
  ...
  <img className='lg:h-16 lg:w-16 md:w-12 md:h-12 h-12 w-12 lg:my-1  relative z-0' src={image2} alt="" />
...
{/* Box--2 */}
<div className="md:w-[95%] w-[95%] lg:w-[95%] mx-auto p-4 relative card !border-t-[3px] !border-t-blue-500 !border-solid">
    <img className='lg:h-16 lg:w-16 md:w-12 md:h-12 h-12 w-12 lg:my-1 md:my-2 relative z-0' src={image3} alt="" />
...
{/* Box--3 */}
<div className="md:w-[95%] w-[95%] lg:w-[95%] mx-auto p-4 relative card !border-t-[3px] !border-t-blue-500 !border-solid">
    <img className='lg:h-16 lg:w-40 md:w-40 md:h-12 h-12 w-24 lg:my-1 md:my-2 relative z-0' src={image4} alt="" />
